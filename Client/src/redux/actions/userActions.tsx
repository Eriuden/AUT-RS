...
export const updateUser = ({userId, name, email, description} : userProps, dispatch: any) => {   
        return axios({
            method:"put",
...
export const deleteUser = ({userId, name, email, password, description} : userProps, dispatch:any) => {
        return axios({
            method:"delete",
            url: `${process.env.REACT_APP_API_URL}api/user/${userId}`,
            data: {name, email, password, description}
        })
        .then(()=> {
