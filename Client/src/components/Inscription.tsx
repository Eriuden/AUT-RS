        ...
        {formSubmit ? (
          ...
          <form action='' onSubmit={handleRegister} className="bg-slate-100 flex
           ...
           my-4 md:mx-[20%] lg:mx-[20%]">
              ...
              <label htmlFor='description' className='mt-2 text-center text-black font-serif'>Votre adresse</label>
              <input className='border-2 border-black mx-12 sm:mx-52 md:mx-[30%]
              lg:mx-[30%]' placeholder="Vous pouvez ici vous présenter (vos passions, votre quotidien avec le TSA, ce que vous voulez)" 
